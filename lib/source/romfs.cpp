...
namespace romfs {
    ...
    [[gnu::visibility("hidden")]] const romfs::Resource &impl::ROMFS_CONCAT(get_, LIBROMFS_PROJECT_NAME)(const std::filesystem::path &path) {
    ...
    [[gnu::visibility("hidden")]] std::vector<std::filesystem::path> impl::ROMFS_CONCAT(list_, LIBROMFS_PROJECT_NAME)(const std::filesystem::path &parent) {
    ...
    [[gnu::visibility("hidden")]] std::string_view impl::ROMFS_CONCAT(name_, LIBROMFS_PROJECT_NAME)() {
